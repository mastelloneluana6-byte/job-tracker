...
export function JobImportWorkflow({
  ...
  const footer = (
    <div className="flex shrink-0 gap-2 border-t border-white/[0.06] p-4">
      ...
      <button
        ...
        className={`rounded-xl bg-gradient-to-b from-[#d4af37] to-[#9a7b1a] py-2.5 text-sm font-semibold text-zinc-950 shadow-lg shadow-[#c9a227]/15 transition hover:brightness-110 disabled:opacity-40 ${
          layout === "modal" ? "flex-1" : "w-full"
        }`}
      >
  ...
  if (layout === "page") {
    return (
      <div className="flex flex-col overflow-hidden rounded-2xl border border-white/[0.1] bg-gradient-to-b from-zinc-900 to-zinc-950 shadow-xl">
        {tabBar}
        {body}
        {footer}
      </div>
